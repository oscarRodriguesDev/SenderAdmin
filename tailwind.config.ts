...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      animation: {
        "lin-spin": "linspin 3s linear infinite",
        "ease-spin": "easespin 3s ease-in-out infinite",
        "left-spin": "left-spin 1.2s linear infinite",
        "right-spin": "right-spin 1.2s linear infinite",
        rotating: "rotating 1s linear infinite",
        topbottom: "topbottom 1.5s cubic-bezier(0.45, 0.05, 0.55, 0.95) infinite",
        bottomtop: "bottomtop 1.5s cubic-bezier(0.45, 0.05, 0.55, 0.95) infinite",
        line: "line 1.5s cubic-bezier(0.45, 0.05, 0.55, 0.95) infinite",
        "line-revert": "line-revert 1.5s cubic-bezier(0.45, 0.05, 0.55, 0.95) infinite",
